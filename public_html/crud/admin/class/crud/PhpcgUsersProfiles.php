...
class PhpcgUsersProfiles extends Elements
{
    ...
    public $read_crm_accounts = array();
    public $update_crm_accounts = array();
    public $create_delete_crm_accounts = array();
    public $constraint_query_crm_accounts = array();
    ...
    public function __construct($element)
    {
        ...
        $qry_start        = 'SELECT `phpcg_users_profiles`.`ID`, `phpcg_users_profiles`.`profile_name`, `phpcg_users_profiles`.`read_crm_accounts`, `phpcg_users_profiles`.`update_crm_accounts`, `phpcg_users_profiles`.`create_delete_crm_accounts`, `phpcg_users_profiles`.`constraint_query_crm_accounts`, `phpcg_users_profiles`.`read_phpcg_users`, `phpcg_users_profiles`.`update_phpcg_users`, `phpcg_users_profiles`.`create_delete_phpcg_users`, `phpcg_users_profiles`.`constraint_query_phpcg_users`, `phpcg_users_profiles`.`read_phpcg_users_profiles`, `phpcg_users_profiles`.`update_phpcg_users_profiles`, `phpcg_users_profiles`.`create_delete_phpcg_users_profiles`, `phpcg_users_profiles`.`constraint_query_phpcg_users_profiles` FROM phpcg_users_profiles';
        ...
        if (!empty($this->records_count)) {
            while (!$db->endOfSeek()) {
                ...
                $this->read_crm_accounts[]= $row->read_crm_accounts;
                $this->update_crm_accounts[]= $row->update_crm_accounts;
                $this->create_delete_crm_accounts[]= $row->create_delete_crm_accounts;
                $this->constraint_query_crm_accounts[]= $row->constraint_query_crm_accounts;
