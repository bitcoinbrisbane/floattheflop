    ...
    types: {
      defaults: {
        ...
        buttons: function(settings, original) {
          ...
          if (settings.submit && settings.cancel) {
            var btnWrapper = $('<div class="btn-group"></div>');
          } else {
          ...
          if (settings.submit) {
            ...
            if (settings.submit.match(/>$/)) {
              ...
              var submit = $('<button type="submit" class="btn btn-primary btn-xs mt-5" />');
          ...
          if (settings.cancel) {
            ...
            if (settings.cancel.match(/>$/)) {
              ...
              var cancel = $('<button type="cancel" class="btn btn-warning btn-xs mt-5" />');
      ...
      select: {
        ...
        plugin: function(b, c) {
          ...
          b.select2 && jQuery.extend(select2, b.select2);
          a.select2(select2);
        }
      }
    },
