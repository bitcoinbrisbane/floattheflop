...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    } if (isset($_POST['cs-step-1']) && Form::testToken('cs-step-1') === true) {
        /* Validate step 1 */
...
if ($current_step == 1) {
    ...
    $form = new Form('cs-step-1', 'horizontal', 'novalidate', 'foundation');
    ...
    $form->addSelect('words-to-describe-our-products[]', 'Which of the following words would you use to describe our products ?', 'class=select2, multiple, required');
    $form->addBtn('submit', 'submit-btn', 1, 'Next <span class="fi fi-arrow-right append"></span>', 'class=success button ladda-button, data-style=zoom-in');
    ...
    $form = new Form('cs-step-2', 'horizontal', 'novalidate', 'foundation');
    // $form->setMode('development');
    $form->setCols(4, 8, 'md');
    ...
    $form->addHelper('multiple choices - choose at least one', 'how-well-do-our-products-meet-your-needs[]');
    $form->addSelect('how-well-do-our-products-meet-your-needs[]', 'How well do our products meet your needs ?', 'class=select2, multiple, required');
    ...
    $form->addBtn('button', 'back-btn', 2, '<span class="fi fi-arrow-left prepend"></span> Back', 'class=button warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 2, 'Next <span class="fi fi-arrow-right append"></span>', 'class=success button ladda-button, data-style=zoom-in', 'btns');
    ...
    $form = new Form('cs-step-3', 'horizontal', 'novalidate', 'foundation');
    // $form->setMode('development');
    $form->setCols(4, 8, 'md');
    ...
    $form->addBtn('button', 'back-btn', 3, '<span class="fi fi-arrow-left prepend"></span> Back', 'class=button warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 3, 'Next <span class="fi fi-arrow-right append"></span>', 'class=success button ladda-button, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
    ...
    $form = new Form('cs-step-4', 'horizontal', 'novalidate', 'foundation');
    // $form->setMode('development');
    $form->setCols(4, 8, 'md');
    ...
    $form->addBtn('button', 'back-btn', 4, '<span class="fi fi-arrow-left prepend"></span> Back', 'class=button warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 4, 'Next <span class="fi fi-arrow-right append"></span>', 'class=success button ladda-button, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
    ...
    $form = new Form('cs-step-5', 'vertical', 'novalidate', 'foundation');
    // $form->setMode('development');
    ...
    $form->addBtn('button', 'back-btn', 5, '<span class="fi fi-arrow-left prepend"></span> Back', 'class=button warning', 'btns');
    $form->addBtn('submit', 'submit-btn', 5, 'Submit <span class="fi fi-arrow-right append"></span>', 'class=success button ladda-button, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
}
