...
$form->addSelect('job-' . $index, 'Job ' . $index, 'class=select2 job, data-placeholder=Select a Job ..., required');

$form->addOption('person-' . $index, '', '');
...
$form->addSelect('person-' . $index, 'Person ' . $index, 'class=select2 person, data-placeholder=Select a Person ..., required');
