...
$form->setCols(0, 12, 'xs');
$form->addRecaptchaV3('6LeNWaQUAAAAAGO_c1ORq2wla-PEFlJruMzyH5L6', 'foundation-contact-form-1');
$form->addHtml('<p>&nbsp;</p>');
...
<head>
    ...
    <title>Foundation Contact Form - How to create PHP forms easily</title>
