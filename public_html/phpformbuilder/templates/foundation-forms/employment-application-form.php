...
$form->startFieldset('Employment Application Form', 'class=fieldset');
...
$form->addSelect('position-applying-for', 'Which position are you applying for ?', 'class=select2, required');
...
$form->addIcon('salary-requirements', '<i class="input-group-label fi-dollar"></i>', 'after');
$form->addInput('text', 'salary-requirements', '', 'Salary Requirements', 'class=input-group-field, data-fv-integer');
$form->endFieldset();
$form->addHtml('<p>&nbsp;</p>');

// Portfolio
$form->startFieldset('Your Portfolio', 'class=fieldset');
...
// Contact Information
$form->startFieldset('Your Contact Information', 'class=fieldset');
$form->setCols(3, 4);
...
$form->addBtn('submit', 'submit-btn', 1, 'Send', 'class=button primary');
...
<head>
    ...
    <meta name="description" content="Foundation Form Generator - how to create an Employment Application Form with Php Form Builder Class">
