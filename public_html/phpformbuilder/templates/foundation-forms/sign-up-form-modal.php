...
$form->addBtn('submit', 'submit-btn', 1, 'Sign Up <i class="fi fi-mail append"></i>', 'class=success button', 'submit_group');
...
<head>
    ...
    <meta name="description" content="Foundation Form Generator - how to create a Sign Up Modal Form with Php Form Builder Class">
