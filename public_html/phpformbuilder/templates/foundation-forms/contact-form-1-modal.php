...
$form->addRecaptchaV3('6LeNWaQUAAAAAGO_c1ORq2wla-PEFlJruMzyH5L6', 'foundation-contact-form-1-modal');
$form->addHtml('<p>&nbsp;</p>');
$form->centerButtons(true);
$form->addBtn('button', 'cancel-btn', 1, 'Cancel', 'class=button secondary, data-modal-close=modal-target', 'submit_group');
$form->addBtn('submit', 'submit-btn', 1, 'Send <i class="fi-mail append"></i>', 'class=success button', 'submit_group');
...
<head>
    ...
    <meta name="description" content="Foundation Form Generator - how to create a Modal Contact Form with Php Form Builder Class">
    ...
    <div class="grid-container">
        <div class="grid-x grid-padding-x">
            <div class="small-10 small-offset-1 medium-8 medium-offset-2 cell">
                ...
                ?>
                <a data-remodal-target="modal-target" class="button primary large">Contact Us</a>
                <?php
                $form->render();
                ?>
            </div>
