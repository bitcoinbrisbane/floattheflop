...
$form = new Form('contact-form-2', 'vertical', 'data-fv-no-icon=true, novalidate');
...
$form->startFieldset('Please fill in this form to contact us')
    ...
    ->printCheckboxGroup('newsletter', 'Suscribe to Newsletter', true, 'class=mr-3 mb-3')
...
<head>
    ...
    <meta name="description" content="Bootstrap 4 Form Generator - how to create a Contact Form Vertical with Php Form Builder Class">
