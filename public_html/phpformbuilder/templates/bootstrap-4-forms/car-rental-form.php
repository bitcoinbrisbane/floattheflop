...
$form = new Form('car-rental-form', 'horizontal', 'data-fv-no-icon=true, novalidate');
...
$form->addHtml('<div class="form-group d-flex justify-content-end">
    <div id="date-time-message-wrapper" class="col-lg-5 py-1 pr-5">
...
<head>
    ...
    <title>Bootstrap 4 Car Rental Form - How to create PHP forms easily</title>
