...
$form = new Form('contact-form-1-popover', 'horizontal', 'data-fv-no-icon=true, novalidate');
...
$form->setCols(0, 12);
$form->addRecaptchaV3('6LeNWaQUAAAAAGO_c1ORq2wla-PEFlJruMzyH5L6', 'bs4-contact-form-1-popover');
...
<head>
    ...
    <meta name="description" content="Bootstrap 4 Form Generator - how to create a Popover Contact Form with Php Form Builder Class">
