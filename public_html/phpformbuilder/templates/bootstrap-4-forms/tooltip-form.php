...
$form = new Form('tooltip-form', 'horizontal', 'data-fv-no-icon=true, novalidate');
...
// icon question sign
$form->addInput('text', 'input-o', '', 'Helper Tooltip <span class="fa fa-question-circle ml-2" data-tooltip="I\'m here to help users to fill-in the following field." data-title="Do you need help ?"></span>', 'required');
...
<head>
    ...
    <meta name="description" content="Bootstrap 4 Form Generator - how to create a Form with tooltips using Php Form Builder Class">
