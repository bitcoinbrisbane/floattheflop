...
$form->addSelect('job-' . $index, 'Job ' . $index, 'class=select2, data-theme=clean, required');
...
$form->addSelect('person-' . $index, 'Person ' . $index, 'class=select2, required');

$options = array(
        'horizontalLabelCol'       => '',
        'horizontalOffsetCol'      => '',
        'horizontalElementCol'     => 'col-sm-2 pt-0'
);
$form->setOptions($options);
