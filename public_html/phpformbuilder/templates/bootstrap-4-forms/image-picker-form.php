...
$form = new Form('image-picker-form', 'vertical', '');
...
<head>
    ...
    <meta name="description" content="Bootstrap 4 Form Generator - how to create an Image picker Form with Php Form Builder Class">
