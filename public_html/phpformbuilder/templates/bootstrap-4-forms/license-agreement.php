...
$form = new Form('license-agreement-form', 'vertical', 'data-fv-no-icon=true, novalidate');
...
<head>
    ...
    <title>Bootstrap 4 License agreement Form - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap 4 Form Generator - how to create a License agreement Form with Php Form Builder Class">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-4-forms/license-agreement-form.php" />
