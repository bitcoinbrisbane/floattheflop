...
$form = new FormExtended('extended-users-form', 'horizontal', 'data-fv-no-icon=true, novalidate');
...
<head>
    ...
    <meta name="description" content="Bootstrap 4 Form Generator - how to create a complete Users Form with Php Form Builder Class">
