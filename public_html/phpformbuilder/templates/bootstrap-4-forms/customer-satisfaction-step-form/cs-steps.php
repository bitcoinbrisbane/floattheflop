...
if ($current_step == 1) {
    ...
    $form = new Form('cs-step-1', 'horizontal', 'data-fv-no-icon=true, novalidate');
    ...
    $form->addSelect('words-to-describe-our-products[]', 'Which of the following words would you use to describe our products ?', 'class=selectpicker, multiple, data-selected-text-format=count, required');
    ...
    $form = new Form('cs-step-2', 'horizontal', 'data-fv-no-icon=true, novalidate');
    // $form->setMode('development');
    ...
    $form->addSelect('how-well-do-our-products-meet-your-needs[]', 'How well do our products meet your needs ?', 'class=selectpicker, multiple, data-selected-text-format=count, required');
    ...
    $form = new Form('cs-step-3', 'horizontal', 'data-fv-no-icon=true, novalidate');
    // $form->setMode('development');
    ...
    $form = new Form('cs-step-4', 'horizontal', 'data-fv-no-icon=true, novalidate');
    // $form->setMode('development');
    ...
    $form = new Form('cs-step-5', 'vertical', 'data-fv-no-icon=true, novalidate');
    // $form->setMode('development');
