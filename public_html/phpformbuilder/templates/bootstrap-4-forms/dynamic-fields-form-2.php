...
$form->addSelect('job-1', 'Job', 'class=select2 job, required');
...
$form->addSelect('person-1', 'Person', 'class=select2 person, required');
...
$form->addHtml('<div class="col-md-3"><button type="button" class="btn btn-primary add-element-button"><i class="fa fa-plus-circle" aria-hidden="true"></i></button><p>&nbsp;</p></div>');
$form->addHtml('</div>');
...
<head>
    ...
    <meta name="description" content="Bootstrap 4 Form Generator - how to load dynamic fields on the fly with Php Form Builder Class">
