...
$form->addSelect('job-' . $index, 'Job ' . $index, 'class=selectpicker job, title=Select a Job ..., required');
...
$form->addSelect('person-' . $index, 'Person ' . $index, 'class=selectpicker person, title=Select a Person ..., required');
