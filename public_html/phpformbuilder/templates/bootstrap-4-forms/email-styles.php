...
$form = new Form('email-styles', 'horizontal', 'data-fv-no-icon=true, novalidate');
...
$form->addSelect('theme[]', 'Choose theme(s):', 'actionsBox=true, selectedTextFormat=static, class=select2, multiple, required');
...
$form->addHtml('<p>&nbsp;</p>');
$form->addHtml('<div class="row justify-content-center"><div class="col-sm-8">');
$form->addRecaptchaV3('6LeNWaQUAAAAAGO_c1ORq2wla-PEFlJruMzyH5L6', 'bs4-email-styles');
...
<head>
    ...
    <title>Bootstrap 4 Styled Email Form - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap 4 Form Generator - how to send different styled emails with Php Form Builder Class">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-4-forms/email-styles.php" />
...
<body>
    <h1 class="text-center">Php Form Builder - Bootstrap 4 Styled Email Form<br><small>send different styled emails using HTML/CSS templates</small></h1>
    <div class="container">
