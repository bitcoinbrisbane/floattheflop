...
$form = new Form('cs-step-plugins-loader', 'horizontal', 'data-fv-no-icon=true, novalidate');
...
<head>
    ...
    <meta name="description" content="Bootstrap 4 Form Generator - how to create a Customer Satisfaction Step Form with Php Form Builder Class">
    ...
    <?php
        ...
        /* =============================================
            ...
            FOR EXAMPLE <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
        ============================================= */
