...
$form = new Form('join-us-modal-form', 'horizontal', 'data-fv-no-icon=true, novalidate', 'bs4');
...
$form->addBtn('button', 'cancel-btn', 1, 'Cancel', 'class=btn btn-secondary, data-modal-close=modal-target', 'submit-group');
$form->addBtn('submit', 'submit-btn', 1, 'Get Access Today<i class="fa fa-unlock fa-lg fa-fw pull-right"></i>', 'class=btn btn-success ladda-button, data-style=zoom-in', 'submit-group');
...
<head>
    ...
    <meta name="description" content="Bootstrap 4 Form Generator - how to create a Join Us Modal Form with Php Form Builder Class">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="text-center">
                <a class="btn btn-primary text-white btn-lg" href="#" data-remodal-target="modal-target">Join us for FREE<i class="fa fa-unlock fa-lg fa-fw pull-right"></i></a>
            </div>
