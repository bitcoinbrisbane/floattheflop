...
<head>
    ...
    <title>Material Design Customer Satisfaction Step Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Design Form Generator - how to create a Customer Satisfaction Step Form with Php Form Builder Class">
...
<body>
    <h1 class="center-align">Php Form Builder - Material Design Customer Satisfaction Step Form<br><small>Step Form with Slide Effect</small></h1>
    <div class="container">
        <?php
            ...
            <div class="col m11 l10">
                ...
                <div id="ajax-form">
                    <div id="slide">
                        ...
                        <div class="step last-step" id="step-5"></div>
                    </div>
                </div>
            </div>
        </div>
