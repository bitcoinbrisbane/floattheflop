...
if ($current_step == 1) {
    ...
    $form->addBtn('submit', 'submit-btn', 1, 'Next <i class="material-icons right">chevron_right</i>', 'class=btn btn-sm waves-effect waves-light ladda-button, data-style=zoom-in');
    ...
    $form->addBtn('button', 'back-btn', 2, '<i class="material-icons right">chevron_left</i> Back', 'class=btn btn-sm orange darken-1 waves-effect waves-light', 'btns');
    $form->addBtn('submit', 'submit-btn', 2, 'Next <i class="material-icons right">chevron_right</i>', 'class=btn btn-sm waves-effect waves-light ladda-button, data-style=zoom-in', 'btns');
    ...
    $form->addBtn('button', 'back-btn', 3, '<i class="material-icons right">chevron_left</i> Back', 'class=btn btn-sm orange darken-1 waves-effect waves-light', 'btns');
    $form->addBtn('submit', 'submit-btn', 3, 'Next <i class="material-icons right">chevron_right</i>', 'class=btn btn-sm waves-effect waves-light ladda-button, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
    ...
    $form->addBtn('button', 'back-btn', 4, '<i class="material-icons right">chevron_left</i> Back', 'class=btn btn-sm orange darken-1 waves-effect waves-light', 'btns');
    $form->addBtn('submit', 'submit-btn', 4, 'Next <i class="material-icons right">chevron_right</i>', 'class=btn btn-sm waves-effect waves-light ladda-button, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
    ...
    $form->addBtn('button', 'back-btn', 5, '<i class="material-icons right">chevron_left</i> Back', 'class=btn btn-sm orange darken-1 waves-effect waves-light', 'btns');
    $form->addBtn('submit', 'submit-btn', 5, 'Submit <i class="material-icons right">chevron_right</i>', 'class=btn btn-sm waves-effect waves-light ladda-button, data-style=zoom-in', 'btns');
    $form->printBtnGroup('btns');
}
$form->render();
