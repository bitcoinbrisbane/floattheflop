...
$form->setCols(0, 12, 'xs');
$form->addRecaptchaV3('6LeNWaQUAAAAAGO_c1ORq2wla-PEFlJruMzyH5L6', 'material-contact-form-1-popover');
...
<head>
    ...
    <title>Material Design Popover Contact Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Design Form Generator - how to create a Popover Contact Form with Php Form Builder Class">
...
<body>
    <h1 class="center-align">Php Form Builder - Material Design Popover Contact Form</h1>
    <div class="container">
        <?php
