...
$form->addInput('hidden', 'user-signature', '', '<span style="margin:10px;">Sign to confirm your agreement</span>', 'class=signature-pad, data-background-color=#F2F2F2, data-pen-color=#333, data-width=100%, data-clear-button=true, data-clear-button-class=btn-small orange, data-clear-button-text=clear, data-fv-not-empty___message=You must sign to accept the license agreement, required');
$form->addRecaptchaV3('6LeNWaQUAAAAAGO_c1ORq2wla-PEFlJruMzyH5L6');
$form->centerButtons(true);
$form->addBtn('submit', 'submit-btn', 1, 'Agree <i class="material-icons right">done</i>', 'class=btn btn-success waves-effect waves-light ladda-button, data-style=zoom-in');
$form->endFieldset();
...
<head>
    ...
    <title>Material Design License agreement Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Design Form Generator - how to create a License agreement Form with Php Form Builder Class">
...
<body>
    <h1 class="center-align">Php Form Builder - Material Design License agreement Form<br><small>with electronic signature</small></h1>
    <div class="container">
        <?php
