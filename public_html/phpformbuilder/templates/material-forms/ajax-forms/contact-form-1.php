...
$form->setCols(6, 6, 'xs');
$form->addCheckbox('newsletter', '', '1', 'class=no-autoinit lcswitch, data-ontext=Yes, data-offtext=No, data-theme=yellow, checked');
...
$form->addBtn('submit', 'submit-btn', 1, 'Send <i class="material-icons right">done</i>', 'class=btn waves-effect waves-light, data-style=zoom-in', 'my-btn-group');
