...
<head>
    ...
    <title>Material Design Customer Support Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Design Form Generator - how to create a Customer Support Form with Php Form Builder Class">
...
<body>
    <h1 class="center-align">Php Form Builder - Material Design Customer Support</h1>
    <div class="container">
        <?php
