...
$form = new Form('join-us-popover-form', 'horizontal', 'novalidate', 'bs3');
...
<head>
    ...
    <title>Bootstrap Join Us Popover Form - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap Form Generator - how to create a Join Us Popover Form with Php Form Builder Class">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-3-forms/join-us-form-popover.php" />
...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <a href="#" id="popover-link" data-width="600" data-placement="right" class="btn btn-primary btn-lg">Join Us</a>
            <?php
                $form->render();
            ?>
        </div>
