...
$form = new Form('contact-form-1-popover', 'horizontal', 'novalidate', 'bs3');
...
$form->addHtml('<p>&nbsp;</p>');
$form->setCols(0, 12, 'xs');
$form->addRecaptchaV3('6LeNWaQUAAAAAGO_c1ORq2wla-PEFlJruMzyH5L6', 'bs3-contact-form-1-popover');
...
<head>
    ...
    <title>Bootstrap Popover Contact Form - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap Form Generator - how to create a Popover Contact Form with Php Form Builder Class">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-3-forms/contact-form-1-popover.php" />
    <style type="text/css">
        #popover-link {
            position: fixed;
            right: 0;
...
<body>
    <h1 class="text-center">Php Form Builder - Bootstrap Popover Contact Form</h1>
    <div class="container">
        <div class="row">
