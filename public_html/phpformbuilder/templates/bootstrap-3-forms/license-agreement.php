...
$form = new Form('license-agreement-form', 'vertical', 'data-fv-no-icon=true, novalidate', 'bs3');
...
$form->addInput('hidden', 'user-signature', '', 'Sign to confirm your agreement', 'class=signature-pad, data-background-color=#F7F7F7, data-pen-color=#333, data-width=100%, data-clear-button=true, data-clear-button-class=btn btn-sm btn-warning, data-clear-button-text=clear, data-fv-not-empty___message=You must sign to accept the license agreement, required');
$form->addRecaptchaV3('6LeNWaQUAAAAAGO_c1ORq2wla-PEFlJruMzyH5L6');
$form->centerButtons(true);
$form->addBtn('submit', 'submit-btn', 1, 'Agree <i class="glyphicon glyphicon-check ml-2" aria-hidden="true"></i>', 'class=btn btn-success ladda-button, data-style=zoom-in');
$form->endFieldset();
...
<head>
    ...
    <title>Bootstrap License agreement Form - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap Form Generator - how to create a License agreement Form with Php Form Builder Class">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-3-forms/license-agreement-form.php" />
...
<body>
    <h1 class="text-center">Php Form Builder - Bootstrap License agreement Form<br><small>with electronic signature</small></h1>
    <div class="container">
        <div class="row">
