...
$form = new Form('customer-support-form', 'horizontal', 'novalidate', 'bs3');
...
<head>
    ...
    <title>Bootstrap 3 Customer Support Form - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap 3 Form Generator - how to create a Customer Support Form with Php Form Builder Class">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-3-forms/customer-support-form.php" />
