...
$form = new Form('dependent-fields', 'horizontal', 'novalidate', 'bs3');
...
$form->addSelect('subject', 'Your request concerns ...', 'class=selectpicker, data-icon-base=glyphicon, data-tick-icon=glyphicon-ok, required');
...
$form->addSelect('civility', 'Civility', 'class=selectpicker, data-icon-base=glyphicon, data-tick-icon=glyphicon-ok, required');
$form->setCols(2, 5);
...
$form->setCols(3, 9, 'sm');
$form->addRecaptchaV3('6LeNWaQUAAAAAGO_c1ORq2wla-PEFlJruMzyH5L6', 'bs3-dependent-fields');
...
<head>
    ...
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-3-forms/dependent-fields.php" />
