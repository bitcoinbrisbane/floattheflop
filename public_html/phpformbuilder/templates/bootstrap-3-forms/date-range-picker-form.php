...
$form = new Form('date-range-picker-form', 'horizontal', 'novalidate', 'bs3');
...
<head>
    ...
    <title>Bootstrap Date range picker Form - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap Form Generator - how to create a Date range picker Form with Php Form Builder Class">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-3-forms/date-range-picker-form.php" />
...
<body>
    <h1 class="text-center">Php Form Builder - Bootstrap Date range picker Form<br><small>with the <em>litepicker</em> picker plugin</small></h1>
    <div class="container">
        <div class="row">
