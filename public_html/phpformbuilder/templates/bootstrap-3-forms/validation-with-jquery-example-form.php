...
$form = new Form('validation-with-jquery-example-form', 'horizontal', 'novalidate', 'bs3');
...
<head>
    ...
    <title>Bootstrap Form with jQuery Live Validation - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap Form Generator - how to create form with jQuery live validation using Php Form Builder Class">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-3-forms/validation-with-jquery-example-form.php" />
