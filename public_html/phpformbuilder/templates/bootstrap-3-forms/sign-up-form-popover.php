...
$form = new Form('sign-up-popover-form-1', 'vertical', 'novalidate', 'bs3');
...
<head>
    ...
    <title>Bootstrap Sign Up Popover Form - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap Form Generator - how to create a Sign Up Popover Form with Php Form Builder Class">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-3-forms/sign-up-form-popover.php" />
...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <a href="#" id="popover-link" data-width="600" data-placement="right" class="btn btn-primary btn-lg">Sign Up</a>
            <?php
                $form->render();
            ?>
        </div>
