...
$form = new Form('fileupload-test-form', 'horizontal', 'novalidate', 'bs3');
...
<head>
    ...
    <title>Bootstrap File Upload Form - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap Form Generator - how to create a File Upload with Php Form Builder Class">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-3-forms/fileupload-test-form.php" />
    <style type="text/css">
        form fieldset {
            background: #fafafa;
            padding: 0 20px;
