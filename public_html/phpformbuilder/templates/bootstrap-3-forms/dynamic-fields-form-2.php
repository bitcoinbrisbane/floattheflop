...
$form->addSelect('job-1', 'Job', 'class=selectpicker job, data-icon-base=glyphicon, data-tick-icon=glyphicon-ok, required');
...
$form->addSelect('person-1', 'Person', 'class=selectpicker person, data-icon-base=glyphicon, data-tick-icon=glyphicon-ok, required');
...
$form->addHtml('<div class="col-md-3"><button type="button" class="btn btn-primary add-element-button"><span class="glyphicon glyphicon-plus-sign"></span></button><p>&nbsp;</p></div>');
$form->addHtml('</div>');
...
<head>
    ...
    <title>Bootstrap 3 Php Form with Ajax dynamic fields - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap 3 Form Generator - how to load dynamic fields on the fly with Php Form Builder Class">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-3-forms/dynamic-fields-form-2.php" />
