...
$form = new Form('email-styles', 'horizontal', 'novalidate', 'bs3');
...
$form->addSelect('theme[]', 'Choose theme(s):', 'class=selectpicker, data-icon-base=glyphicon, data-tick-icon=glyphicon-ok, actionsBox=true, selectedTextFormat=static, multiple, required');
...
$form->addRecaptchaV3('6LeNWaQUAAAAAGO_c1ORq2wla-PEFlJruMzyH5L6', 'bs3-email-styles');
...
<head>
    ...
    <title>Bootstrap Styled Email Form - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap Form Generator - how to send different styled emails with Php Form Builder Class">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-3-forms/email-styles.php" />
...
<body>
    <h1 class="text-center">Php Form Builder - Bootstrap Styled Email Form<br><small>send different styled emails using HTML/CSS templates</small></h1>
    <div class="container">
        <div class="row">
