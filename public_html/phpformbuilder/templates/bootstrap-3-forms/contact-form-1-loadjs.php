...
$form = new Form('contact-form-1-loadjs', 'horizontal', 'novalidate', 'bs3');
...
<head>
    ...
    <title>Bootstrap Contact Form loaded with LoadJs - How to create PHP forms easily</title>
    <meta name="description" content="Bootstrap Form Generator - how to create a Contact Form loaded with LoadJs and Php Form Builder Class">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/bootstrap-3-forms/contact-form-1-loadjs.php" />
...
<body>
    <h1 class="text-center">Php Form Builder - Bootstrap Horizontal Contact Form<br><small>with icons &amp; placeholders<br>Loaded with LoadJs Library</small></h1>
    <div class="container">
        <div class="row">
