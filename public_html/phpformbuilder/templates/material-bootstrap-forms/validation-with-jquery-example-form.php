...
// materialize plugin
$form->addPlugin('materialize', '#validation-with-jquery-example-form');
...
<head>
    ...
    <title>Material Design Bootstrap 4 Form with jQuery Live Validation - How to create PHP forms easily</title>
    <meta name="description" content="Material Design Bootstrap 4 Form Generator - how to create form with jQuery live validation using Php Form Builder Class">
...
<body>
    <h1 class="text-center">Php Form Builder - Material Design Bootstrap 4 Form with jQuery Live Validation<br><small>real time validation using jQuery validator plugin</small></h1>
    <div class="container">
        <?php
