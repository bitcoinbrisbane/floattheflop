...
$form->addIcon('salary-requirements', '<i class="fa fa-lg fa-usd" aria-hidden="true"></i>', 'after');
...
<head>
    ...
    <title>Material Design Bootstrap 4 Employment Application Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Design Bootstrap 4 Form Generator - how to create an Employment Application Form with Php Form Builder Class">
...
<body>
    <h1 class="text-center">Php Form Builder - Material Design Bootstrap 4 Employment Application Form<br><small>with File uploader &amp; date picker</small></h1>
    <div class="container">
        <?php
