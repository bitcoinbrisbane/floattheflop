...
if ($current_step == 1) {
    ...
    // materialize plugin
    $form->addPlugin('materialize', '#form-step-2');
    ...
    $form->addBtn('submit', 'back-btn', 1, '<span class="fa fa-arrow-left mr-2"></span> Back', 'class=btn btn-sm btn-warning', 'btns');
    ...
    // $form->setMode('development');
        ...
        // materialize plugin
    $form->addPlugin('materialize', '#form-step-3');
    ...
    $form->addBtn('submit', 'back-btn', 2, '<span class="fa fa-arrow-left mr-2"></span> Back', 'class=btn btn-sm btn-warning', 'btns');
...
<head>
    ...
    <title>Material Design Bootstrap 4 Simple Step Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Design Bootstrap 4 Form Generator - how to create a simple Step Form with Php Form Builder Class">
...
<body>
    <h1 class="text-center">Php Form Builder - Material Design Bootstrap 4 Simple Step Form<br><small>follow steps to complete</small></h1>
    <div class="container">
        <?php
