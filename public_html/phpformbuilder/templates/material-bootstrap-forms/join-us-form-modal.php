    ...
    <div class="container">
        <div class="row">
            ...
            <div class="text-center">
                <a class="btn btn-primary text-white btn-lg" href="#" data-remodal-target="modal-target">Join us for FREE<i class="fa fa-lg fa-unlock fa-lg fa-fw pull-right"></i></a>
            </div>
