...
if ($_SERVER["REQUEST_METHOD"] == "POST" && Form::testToken('mb-date-range-picker-form') === true) {
    // create validator & auto-validate required fields
    $validator = Form::validate('mb-date-range-picker-form');
    ...
    if ($validator->hasErrors()) {
        $_SESSION['errors']['mb-date-range-picker-form'] = $validator->getAllErrors();
    } else {
        ...
        $email_config = array(
            ...
            'filter_values'   => 'mb-date-range-picker-form'
        );
        $sent_message = Form::sendMail($email_config);
        Form::clear('mb-date-range-picker-form');
    }
}
...
$form = new Form('mb-date-range-picker-form', 'horizontal', 'novalidate', 'material');
$form->setMode('development');

// materialize plugin
$form->addPlugin('materialize', '#mb-date-range-picker-form');
...
// jQuery validation
$form->addPlugin('formvalidation', '#mb-date-range-picker-form');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Material Design Bootstrap 4 Date range picker Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Design Bootstrap 4 Form Generator - how to create a Date range picker Form with Php Form Builder Class">
...
<body>
    <h1 class="text-center">Php Form Builder - Material Design Bootstrap 4 Date range picker Form<br><small>with the <em>litepicker</em> picker plugin</small></h1>
    <div class="container">
        <?php
