...
$form->addOption('category', '', 'Choose a category', '', 'disabled selected');

for ($i=0; $i < $db_count; $i++) {
    $form->addOption('category', $categories[$i], $categories[$i]);
}
$form->addSelect('category', 'Category', 'class=select2 no-autoinit, data-placeholder=Choose a category, data-minimum-results-for-search=Infinity, required');
$form->addSelect('product', 'Product', 'class=select2 no-autoinit, data-placeholder=Choose a category first, disabled, required');
...
<head>
    ...
    <title>Material Design Bootstrap 4 Customer Support Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Design Bootstrap 4 Form Generator - how to create a Customer Support Form with Php Form Builder Class">
...
<body>
    <h1 class="text-center">Php Form Builder - Material Design Bootstrap 4 Customer Support</h1>
    <div class="container">
        <?php
