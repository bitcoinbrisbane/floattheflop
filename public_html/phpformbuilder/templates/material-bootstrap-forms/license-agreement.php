...
$form = new Form('license-agreement-form', 'vertical', 'data-fv-no-icon=true, novalidate', 'material');
...
$form->addHtml('<div class="row"><div class="col" style="height:150px;overflow:auto"><h4>Terms & conditions</h4><p><small>' . $license_text . '</small></p></div></div>');
$form->addInput('hidden', 'user-signature', '', '<span style="margin:10px;">Sign to confirm your agreement</span>', 'class=signature-pad, data-background-color=#F7F7F7, data-pen-color=#333, data-width=100%, data-clear-button=true, data-clear-button-class=btn btn-sm btn-warning, data-clear-button-text=clear, data-fv-not-empty___message=You must sign to accept the license agreement, required');
$form->addRecaptchaV3('6LeNWaQUAAAAAGO_c1ORq2wla-PEFlJruMzyH5L6');
$form->centerButtons(true);
$form->addBtn('submit', 'submit-btn', 1, 'Agree <i class="fa fa-check ml-2" aria-hidden="true"></i>', 'class=btn btn-success ladda-button, data-style=zoom-in');
$form->endFieldset();
...
<head>
    ...
    <title>Material Design Bootstrap 4 License agreement Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Design Bootstrap 4 Form Generator - how to create a License agreement Form with Php Form Builder Class">
    <link rel="canonical" href="https://www.phpformbuilder.pro/templates/material-forms/license-agreement-form.php" />
...
<body>
    <h1 class="text-center">Php Form Builder - Material Design Bootstrap 4 License agreement Form<br><small>with electronic signature</small></h1>
    <div class="container">
        <?php
