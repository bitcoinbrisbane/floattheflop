...
if ($_SERVER["REQUEST_METHOD"] == "POST" && Form::testToken('mb-contact-form-1') === true) {
    // create validator & auto-validate required fields
    $validator = Form::validate('mb-contact-form-1');
    ...
    if ($validator->hasErrors()) {
        $_SESSION['errors']['mb-contact-form-1'] = $validator->getAllErrors();
        var_dump($_SESSION['errors']['mb-contact-form-1']);
    } else {
        ...
        $email_config = array(
            ...
            'filter_values'   => 'mb-contact-form-1'
        );
        $sent_message = Form::sendMail($email_config);
        Form::clear('mb-contact-form-1');
    }
}
...
$form = new Form('mb-contact-form-1', 'horizontal', 'novalidate', 'material');
// $form->setMode('development');

// materialize plugin
$form->addPlugin('materialize', '#mb-contact-form-1');
...
$form->setCols(0, 12, 'xs');
$form->addRecaptchaV3('6LeNWaQUAAAAAGO_c1ORq2wla-PEFlJruMzyH5L6', 'mb-contact-form-1');
...
// jQuery validation
$form->addPlugin('formvalidation', '#mb-contact-form-1');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Material Design Bootstrap 4 Contact Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Design Bootstrap 4 Form Generator - how to create a Contact Form with Php Form Builder Class">
...
<body>
    <h1 class="text-center">Php Form Builder - Material Design Bootstrap 4 Horizontal Contact Form<br><small>with icons &amp; placeholders</small></h1>
    <div class="container">
        <?php
