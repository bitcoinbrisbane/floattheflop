...
<head>
    ...
    <title>Material Design Bootstrap 4 File Upload Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Design Bootstrap 4 Form Generator - how to create a File Upload with Php Form Builder Class">
...
<body>
    <h1 class="text-center">Php Form Builder - Material Design Bootstrap 4 File Upload Form<br><small>Upload documents or images</small></h1>
    <div class="container">
        <?php
