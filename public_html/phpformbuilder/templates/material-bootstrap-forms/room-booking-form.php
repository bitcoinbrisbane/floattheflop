...
$form->setCols(3, 3);
$form->addIcon('number-of-nights', '<i class="fa fa-lg fa-bed"></i>', 'before');
...
$form->addIcon('number-of-guests', '<i class="fa fa-lg fa-user-plus"></i>', 'before');
...
<head>
    ...
    <title>Material Design Bootstrap 4 Room Booking Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Design Bootstrap 4 Form Generator - how to create a Room Booking Form with Php Form Builder Class">
...
<body>
    <h1 class="text-center">Php Form Builder - Material Design Bootstrap 4 Room Booking Form<br><small>with Rich Text Editor and date picker</small></h1>
    <div class="container">
        <?php
