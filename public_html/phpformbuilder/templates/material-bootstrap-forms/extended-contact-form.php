...
<head>
    ...
    <title>Material Design Bootstrap 4 Extended Contact Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Design Bootstrap 4 Form Generator - how to create an Extended Contact Form with Php Form Builder Class">
...
<body>
    <h1 class="text-center">Php Form Builder - Material Design Bootstrap 4 Extended Contact Form<br><small>Build a complete contact form with a single line of code</small></h1>
    <div class="container">
        <?php
