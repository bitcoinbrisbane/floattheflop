...
$form->addHtml('<div class="col-md-3"><button type="button" class="btn btn-primary add-element-button"><i class="fa fa-lg fa-plus-circle" aria-hidden="true"></i></button><p>&nbsp;</p></div>');
$form->addHtml('</div>');
...
<head>
    ...
    <title>Material Design Bootstrap 4 Php Form with Ajax dynamic fields - How to create PHP forms easily</title>
    <meta name="description" content="Material Design Bootstrap 4 Form Generator - how to load dynamic fields on the fly with Php Form Builder Class">
...
<body>
    <h1 class="text-center">Php Form Builder - Material Design Bootstrap 4 Form with dynamic ajax-loaded fields<br><small>Click "+" or "-" buttons to add or remove fields</small></h1>
    <div class="container">
        <?php
        ...
        $(document).ready(function () {
            ...
            $('.add-element-button').on('click', function () {
                ...
                $.ajax({
                    ...
                    // material select
                    $('#ajax-elements-container select').formSelect();
