...
// icon question sign
$form->addInput('text', 'input-o', '', 'Helper Tooltip <span class="fa fa-lg fa-question-circle ml-2" data-tooltip="I\'m here to help users to fill-in the following field." data-title="Do you need help ?"></span>', 'required');
...
$form->addHtml('<div class="col-sm-8"><p>You can mix shadows and rounded corners with any style</p></div>');
...
<head>
    ...
    <title>Material Design Bootstrap 4 Form with Tooltips - How to create PHP forms easily</title>
    <meta name="description" content="Material Design Bootstrap 4 Form Generator - how to create a Form with tooltips using Php Form Builder Class">
...
<body>
    <h1 class="text-center">Php Form Builder - Material Design Bootstrap 4 Form with tooltips</h1>
    <div class="container">
        <?php
