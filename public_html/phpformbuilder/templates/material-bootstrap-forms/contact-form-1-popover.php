...
$form->setCols(0, 12, 'xs');
$form->addRecaptchaV3('6LeNWaQUAAAAAGO_c1ORq2wla-PEFlJruMzyH5L6', 'mb-contact-form-1-popover');
...
<head>
    ...
    <title>Material Design Bootstrap 4 Popover Contact Form - How to create PHP forms easily</title>
    <meta name="description" content="Material Design Bootstrap 4 Form Generator - how to create a Popover Contact Form with Php Form Builder Class">
...
<body>
    <h1 class="text-center">Php Form Builder - Material Design Bootstrap 4 Popover Contact Form</h1>
    <div class="container">
        <?php
